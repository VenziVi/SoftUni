...
namespace SimpleSnake.GameObjects
{
    public abstract class Food : Point
    {
        ...
        private ConsoleColor currentFoodColor;

        protected Food(Wall wall, char foodSymbol, int points, ConsoleColor currentFoodColor) 
        ...
        public void SetRandomPosition(Queue<Point> snakeElements)
        {
            ...
            Console.BackgroundColor = currentFoodColor;
