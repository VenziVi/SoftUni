function attachEvents() {
    ...
    function getWeather() {
        ...
        function createDayReport(forecast) {
            ...
            symbolSpan.textContent = getPics(forecast.condition);
        ...
        function createCurrentWeatherElement(weatherReport) {
            ...
            conditionSymbolSpan.textContent = getPics(weatherReport.forecast.condition);
    ...
    function getPics(type){
        if (type === 'Sunny') {
            return '☀';
        }else if (type === 'Partly sunny') {
            return '⛅';
